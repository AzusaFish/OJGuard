...
function runCapture(command, args, options = {}) {
  const resolvedCommand = command === "unzip"
    ? "C:\\Users\\AzusaFish\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\python\\python.exe"
    : command;
  const resolvedArgs = command === "unzip"
    ? ["D:\\AzusaFish\\Codes\\Development\\OJGuard\\tmp\\ppt-template\\bin\\unzip_compat.py", ...args]
    : args;
